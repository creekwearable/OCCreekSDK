...
typedef void(^DevicesBack)(NSArray<ScanDeviceModel *>*);
typedef void(^DeviceBack)(ScanDeviceModel*);
typedef void(^EndScanBase)(void);
typedef void(^ConnectBack)(BOOL);
typedef void(^InTransitionDeviceBack)(BOOL);
typedef void(^ProgressBase)(NSInteger);
typedef void(^SuccessBase)(void);
typedef void(^FailureBase)(void);
typedef void(^FailureArgument)(NSInteger,NSString*);
typedef void(^ListenDeviceState)(ConnectionStatus,NSString*);
typedef void(^NoticeUpdateListen)(NoticeUpdateModel*);
typedef void(^EventReportListen)(EventReportModel*);
typedef void(^ExceptionListen)(NSString*);
typedef void(^SNFirmwareBase)(NSString*);
typedef void(^RawQueryDBClosure)(NSString*);
typedef void(^EphemerisData)(NSData*);
typedef void(^LogPathClosure)(NSString*);

typedef void (^FirmwareBase)(protocol_device_info *);
typedef void (^ATimeBase)(protocol_device_time_inquire_reply*);
typedef void (^LanguageBase)(protocol_language_inquire_reply*);
typedef void (^UserBase)(protocol_user_info_operate*);
typedef void (^AlarmBase)(protocol_alarm_inquire_reply*);
typedef void (^DisturbBase)(protocol_disturb_inquire_reply*);
typedef void (^ScreenBase)(protocol_screen_brightness_inquire_reply*);
typedef void (^MonitorBase)(protocol_health_monitor_inquire_reply*);
typedef void (^SleepMonitorBase)(protocol_sleep_monitor_inquire_reply*);
typedef void (^WaterBase)(protocol_drink_water_inquire_reply*);
typedef void (^FindPhoneWatchBase)(protocol_find_phone_watch_inquire_reply*);
typedef void (^VoiceBase)(protocol_voice_assistant_inquire_reply*);
typedef void (^WorldTimeBase)(protocol_world_time_inquire_reply*);
typedef void (^StandingBase)(protocol_standing_remind_inquire_reply*);
typedef void (^MessageTypeBase)(protocol_message_notify_func_support_reply*);
typedef void (^MessageAppBase)(protocol_message_notify_data_inquire_reply*);
typedef void (^MessageOnOffBase)(protocol_message_notify_switch_inquire_reply*);
typedef void (^CallBase)(protocol_call_switch_inquire_reply*);
typedef void (^ContactsBase)(protocol_frequent_contacts_inquire_reply*);
typedef void (^SosContactsBase)(protocol_emergency_contacts_inquire_reply*);
typedef void (^CardBase)(protocol_quick_card_inquire_reply*);
typedef void (^SportTypeBase)(protocol_exercise_func_support_reply*);
typedef void (^SportSortBase)(protocol_exercise_sport_mode_sort_inquire_reply*);
typedef void (^SportSubBase)(protocol_exercise_sporting_param_sort_inquire_reply*);
typedef void (^SportIdentificationBase)(protocol_exercise_intelligent_recognition_inquire_reply*);
typedef void (^WatchDialBase)(protocol_watch_dial_plate_inquire_reply*);
typedef void (^HotKeyBase)(protocol_button_crown_inquire_reply*);
typedef void (^MenstrualBase)(protocol_menstruation_inquire_reply*);
typedef void (^FocusBase)(protocol_focus_mode_inquire_reply*);
typedef void (^TableBase)(protocol_function_table*);
typedef void (^BluetoothStatusBase)(protocol_connect_status_inquire_reply*);

typedef void(^ActivitysClosure)(NSArray<ActivityModel *>*);
typedef void(^HeartRatesClosure)(NSArray<HeartRateModel *>*);
typedef void(^StresssClosure)(NSArray<StressModel *>*);
typedef void(^NoisesClosure)(NSArray<NoiseModel *>*);
typedef void(^OxygensClosure)(NSArray<OxygenModel *>*);
typedef void(^SleepsClosure)(NSArray<SleepModel *>*);
typedef void(^SportsClosure)(NSArray<SportModel *>*);
typedef void(^HrvsClosure)(NSArray<HrvModel *>*);
typedef void(^SportClosure)(SportModel*);
typedef void(^SNFirmwareBase)(NSString*);

...
class CustomSheetView: BaseSheetView ,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if self.models.isEmpty{
           return 0
            ...
            return self.models[selectIndex].typeModels.count
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let isSelect = self.models[selectIndex].selectedIndex.intValue == indexPath.row
        ...
        cell?.callBlock = {
            ...
            self.models.forEach { dialFunctionModel in
                if self.selectIndex == i {
                    ...
                    selectIndexs.append(dialFunctionModel.selectedIndex.intValue)
                }
                i+=1
            }
